...
### [источник про URI URL URN](https://wiki.merionet.ru/servernye-resheniya/36/url-i-uri-v-chem-razlichie/)
...
# 8.  **GraphQL**
**GraphQL** –  стиль проектирования API, где все рассматривается как граф, в котором данные взаимосвязаны. Это означает, что запрос можно настроить таким образом, чтобы из одной конечной точки получить всю необходимую информацию – и ничего больше. Таким образом можно даже объединять в одном запросе разные сущности.
...
### [сравнение REST и GraphQL](https://proglib.io/p/hvatit-ispolzovat-rest-dlya-api-2020-12-12)
